    ...
    return(
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
         <div className='text-center mt-20 mb-8'>
              ...
              <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-800'>Your Own <span className='text-primary'>Blogging</span> 
                <br /> Platform</h1>
               <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>This is your space to think out loud to share what  matters,
                 ...
                 yours story starts right here </p>
         ...
         <img src={assets.gradientBackground} alt="gradient backgroung" className='absolute -top-50 -z-1 opacity-50' />
        </div>
    );
}
