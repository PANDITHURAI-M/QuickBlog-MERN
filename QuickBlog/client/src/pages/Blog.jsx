...
const Blog=()=>{
 ...
 // whenever the component is loaded use effect will call the fetchblogdata()
    useEffect(()=>{
        fetchBlogData();
        fetchComments();
    },[])
    ...
    return data ? (
        <div className='relative'>
            ...
            <div className='text-center mt-20 text-gray-600'>
                ...
                <h2 className='my-5 max-w-lg truncate mx-auto'>{data.subTitle
                    }</h2>
                <p className='inline-block py-1 px-4 rounded-full mb-6 border texxt-sm border-primary/35
                ...
                <div className='rich-text max-w-3xl mx-auto' dangerouslySetInnerHTML={{__html:data.description }}>
                 ...
                 <div className='max-w-3xl mx-auto'>
                    ...
                    max-w-lg'>
                        ...
                        <textarea onChange={(e)=>setContent(e.target.value)} value={content} name="" id="" placeholder='Comment' className='w-full p-2 border
